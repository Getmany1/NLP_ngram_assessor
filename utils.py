...
def morph_segment(corpus, morph_model):
    ...
    # Make a new corpus from word segments
    for sent in text:
        sent_segmented = []
        for word in sent:
            # The most likely word segmentation is typically the word itself.
            # Thus, use the second most likely word segmentation if
            # number of possible segmentations is more than 1
